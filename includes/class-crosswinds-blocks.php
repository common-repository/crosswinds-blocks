...
class Crosswinds_Blocks {
	...
	private function load_dependencies() {
		...
		if ( is_admin() ) {
			require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/importer/importer.php';
		}
	...
	private function define_admin_hooks() {
		...
		$this->loader->add_action( 'user_contactmethods', $admin, 'add_social_media_fields' );
		$this->loader->add_action( 'rest_api_init', $admin, 'rest_api_endpoints' );
	}
	...
	private function define_public_hooks() {
		...
		$this->loader->add_filter( 'wp_theme_json_data_theme', $public, 'set_theme_styles' );
		$this->loader->add_action( 'wp_head', $public, 'add_favicon' );
		$this->loader->add_filter( 'wp_kses_allowed_html', $public, 'allow_form_elements_kses', 10, 2 );
	}
