...
$blocks = array(
	...
	'author-social-icons' => array(
		'slug'               => 'author-social-icons',
		'name'               => esc_html__( 'Author Social Icons', 'crosswinds-blocks' ),
		'description'        => esc_html__( 'Add links to an author social media accounts.', 'crosswinds-blocks' ),
		'documentation_link' => '',
		'icon'               => '<svg xmlns="http://www.w3.org/2000/svg" height="16" width="20" viewBox="0 0 640 512"><path class="fa-secondary" fill="#8200ff" d="M579.8 63.2c56.5 56.5 56.5 148 0 204.5L467.5 380c-56.5 56.5-148 56.5-204.5 0c-50-50-56.5-128.8-15.4-186.3l1.1-1.6c10.3-14.4 30.3-17.7 44.6-7.4s17.7 30.3 7.4 44.6l-1.1 1.6c-22.9 32.1-19.3 76 8.6 103.8c31.5 31.5 82.5 31.5 114 0L534.5 222.5c31.5-31.5 31.5-82.5 0-114C506.7 80.6 462.7 77 430.7 99.9l-1.6 1.1c-14.4 10.3-34.4 6.9-44.6-7.4s-6.9-34.4 7.4-44.6l1.6-1.1C451 6.7 529.8 13.3 579.8 63.2z"/><path class="fa-primary" fill="#171247" d="M60.2 448.8c-56.5-56.5-56.5-148 0-204.5L172.5 132c56.5-56.5 148-56.5 204.5 0c50 50 56.5 128.8 15.4 186.3l-1.1 1.6c-10.3 14.4-30.3 17.7-44.6 7.4s-17.7-30.3-7.4-44.6l1.1-1.6c22.9-32.1 19.3-76-8.6-103.9c-31.5-31.5-82.5-31.5-114 0L105.5 289.5C74 321 74 372 105.5 403.5c27.9 27.9 71.8 31.5 103.8 8.6l1.6-1.1c14.4-10.3 34.4-6.9 44.6 7.4s6.9 34.4-7.4 44.6l-1.6 1.1C189 505.3 110.2 498.7 60.2 448.8z"/></svg>',
	),
	'acf-field' => array(
		'slug'               => 'acf-field',
	...
	'search-filters' => array(
		'slug'               => 'search-filters',
		'name'               => esc_html__( 'Search Filters', 'crosswinds-blocks' ),
		'description'        => esc_html__( 'Add in blocks to help you create a search filters sections for any post type.', 'crosswinds-blocks' ),
		'documentation_link' => '',
